...
select case (type)
case ('A')
	write (*, 600) type,fields(var),var%name,var%info%name,trim(var%info%long_name)
case ('B')
	write (*, 600) type,fields(var),var%name,var%info%backup,trim(var%info%long_name)
case ('N', 'M', 'G')
	write (*, 600) type,fields(var),var%name,var%info%dataname,trim(var%info%long_name)
case default
	if (show_x) write (*, 600) type,fields(var),var%name,var%info%dataname,trim(var%info%long_name)
end select
