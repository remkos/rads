**RQSORT -- Make a quick sort of an REAL*4 array
*+
      SUBROUTINE RQSORT (INDX, ARR, NR)
      INTEGER*4 NR, INDX(NR)
      REAL*4 ARR(*)
*
* This routine quick-sorts an INTEGER*4 array INDX according to the
* corresponding value in array ARR of type REAL*4 .
...
* ARR (input) : One-dimensional array of values (REAL*4)
...
* NR 6
*
* After running RQSORT, the output will look like this:
*
* INDX 2 3 5 4 6 1
* ARR 100 10 11 21 17 90
* NR 6
...
* NR 6
*
* Then after running RQSORT, the result will be:
*
* INDX 8 2 5 4 6 1
* ARR 100 10 ** 21 17 90 ** 1
* NR 6
