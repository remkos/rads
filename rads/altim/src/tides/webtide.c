...
*
* $Log: webtide.c,v $
* Revision 1.5  2017/10/11 09:33:50  rads
* - Updates for gcc7
*
* Revision 1.4  2011/07/29 23:19:05  rads
* - Fixed problems with elements crossing International Dateline and Greenwich
*   Meridian, as in version 2.5.1 of webtidecor.c
*
