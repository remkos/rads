...
\item Orbits produced under strict Jason GDR-D standards (current baseline). Data since April 2015 are in fact produced with GDR-E standards, but the variable name and comment have not been updated to reflect this.\label{item:alt_gdrd}
...
\item Orbits provided by GSFC using their standards "Std1404". They are "GDR-E" comparable.\label{item:alt_std1404}
\item Orbits products under strict Jason GDR-E standards (baseline for the production of orbits since April 2015).\label{item:alt_gdre}
...
\var{tide_ocean_got47} & 1217 & GOT4.7  ocean tide & m & e1 e2 g1 gs pn tx & -5 5 & \ref{item:tide_ocean_got47} \\
\var{tide_load_got47}  & 1317 & GOT4.7  load  tide & m & e1 e2 g1 gs pn tx & -0.5 0.5 & \ref{item:tide_load_got47} \\
...
\var{tide_ocean_got49} & 1221 & GOT4.9  ocean tide & m & e1 j1 n1 pn tx & -5 5 & \ref{item:tide_ocean_got49} \\
\var{tide_load_got49}  & 1321 & GOT4.9  load  tide & m & e1 j1 n1 pn tx & -0.5 0.5 & \ref{item:tide_load_got49} \\
\var{tide_ocean_got410}& 1222 & GOT4.10 ocean tide & m & c2 j1 j2 pn sa tx & -5 5 & \ref{item:tide_ocean_got410} \\
\var{tide_load_got410} & 1322 & GOT4.10 load  tide & m & c2 j1 j2 pn sa tx & -0.5 0.5 & \ref{item:tide_load_got410} \\
\var{tide_ocean_fes12} & 1223 & FES2012 ocean tide & m & c2 j1 j2 pn sa tx & -5 5 & \ref{item:tide_ocean_fes12} \\
