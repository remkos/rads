...
\var{alt_gdre}     & 425 & CNES GDR-E altitude & m & c2 j2 && \ref{item:alt_gdre} \\
...
\var{alt} & 4 & \alias{alt_gdre} \alias{alt_gdrd} & & j2 && \ref{item:alt} \\
\var{alt} & 4 & \alias{alt_gdrd} & & sa && \ref{item:alt} \\
...
\item Orbits produced by CNES under strict Jason GDR-D standards (current baseline) \citep{ids2011}. Data since April 2015 are in fact produced with GDR-E standards, but the variable name and comment have not been updated to reflect this.\label{item:alt_gdrd}
...
\var{mss_dtu10} & 1613 & DTU10 mean sea surface & m & e1 e2 gs g1 tx n1 j1 & -200 200 & \ref{item:mss_dtu10} \\
...
\var{mss_dtu15} & 1616 & DTU15 mean sea surface & m & c2 j2 sa & -200 200 & \ref{item:mss_dtu15} \\
...
\item The DTU10 mean sea surface model was created at DTU and based on RADS altimeter data \citep{andersen2010}. It is a follow-on of the DNSC08 mean sea surface model \citep{andersen2009}. \textbf{This field is slated to be removed from all datasets.}\label{item:mss_dtu10}
