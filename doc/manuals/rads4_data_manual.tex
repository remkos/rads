...
\var{alt_gdre}     & 425 & CNES GDR-E altitude & m & c2 j2 j3 sw sa && \ref{item:alt_gdre} \\
...
\var{alt} & 4 & \alias{alt_gdre} & & j3 sw sa && \ref{item:alt} \\
...
& & ~~~ \var{iono_gim} \var{iono_nic09} & & j1 j2 j3 sw n1 tx && \ref{item:iono} \\
...
\var{ssb_cls} & 1502 & CLS non-parametric SSB & m & j1 j2 j3 sw n1 tx       & -1 1 & \ref{item:ssb_cls} \\
...
\var{ssb}     &   15 & \alias{ssb_cls} && j1 j2 j3 sw n1 tx && \\
...
\hline
\var{swh_ww3} & 1712 & WAVEWATCH3 significant wave height & m & c2 j2 j3 sw sa & & \ref{item:swh_ww3} \\
\hline
...
\var{wind_speed_rad} & 1902 & radiometer wind speed & m/s & j1 j2 j3 sw pn tx & 0 30 & \\
\var{wind_speed_ecmwf_u} & 1903 & ECMWF model wind speed (U) & m/s & e2 j1 j2 j3 sw n1 sa & & \ref{item:wind_speed_ecmwf} \\
\var{wind_speed_ecmwf_v} & 1904 & ECMWF model wind speed (V) & m/s & e2 j1 j2 j3 sw n1 sa & & \ref{item:wind_speed_ecmwf} \\
\var{wind_speed_ecmwf} & & ECMWF model wind speed & m/s & e2 j1 j2 j3 sw n1 sa & & \ref{item:wind_speed_ecmwf} \\
...
\begin{vartable}
\var{flags} & 2601 & flag word & & 3a 3b & 65448 0 & \ref{item:no_rad_land} \\
            &      &           & & c2 & 32 0 & \\
...
\var{flag_alt_oper_mode} & 2516 & bit 0: hardware/software status & 0 = nominal, 1 = bad & pn tx & \\
                         & 2516 & bit 0: altimeter operating mode & 0 = Side A, 1 = Side B & j1 j2 j3 sw n1 & \\
                         & 2516 & bit 0: altimeter operating mode & 0 = LRM, 1 = SAR & 3a 3b 6a c2 & \\
\var{qual_sptr}          & 2516 & bit 0: SPTR availability & & e1 & \\
\var{qual_attitude}      & 2501 & bit 1: quality of attitude & 0 = ok, 1 = bad & 3a 3b 6a e2 j1 j2 j3 sw n1 tx sa & \\
...
\var{flag_continental_ice} & 2502 & bit 2: continental ice flag & 0 = no, 1 = yes & 3a 3b 6a c2 j1 j2 j3 sw n1 sa & \\
\var{qual_iono_alt}      & 2503 & bit 3: quality of dual-frequency iono corr & 0 = ok, 1 = bad & 3a 3b 6a j1 j2 j3 sw n1 tx \\
...
\var{qual_alt_rain_ice}  & 2507 & bit 7: altimeter rain/ice flag & 0 = no rain/ice, 1 = rain/ice & 3a 3b 6a g1 j1 j2 j3 sw n1 pn sa tx & \\
\var{qual_rad_rain_ice}  & 2508 & bit 8: radiometer rain/ice flag & 0 = no rain/ice, 1 = rain/ice & 3a 3b 6a e1 e2 j1 j2 j3 sw n1 pn tx & \\
...
\var{qual_sig0}          & 2513 & bit 13: quality of wind speed & 0 = ok, 1 = suspect & gs & \\
...
\begin{vartable}
\var{topo_dtm2000}    & 2202 & DTM2000 topography    & m & j1 j2 j3 sw n1 sa          & & \ref{item:topo_dtm2000} \\
