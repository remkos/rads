...
\url{http://www.aviso.altimetry.fr/en/data/products/auxiliary-products/global-tide-fes.html}\label{item:tide_ocean_fes14}\label{item:tide_load_fes14}
...
\begin{notes}
\item Combined geoid and mean sea surface solution \citep{pavlis2008}..\textbf{The MSS EGM2008 model is slowly being removed from RADS4 as DTU15 and CNES/CLS 15 are much better alternatives.}\label{item:mss_egm2008}\label{item:geoid_egm2008}
