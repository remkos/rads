**DQSORT -- Make a quick sort of an REAL*8 array
*+
      SUBROUTINE DQSORT (INDX, ARR, NR)
      INTEGER*4 NR, INDX(NR)
      REAL*8 ARR(*)
*
* This routine quick-sorts an INTEGER*4 array INDX according to the
* corresponding value in array ARR of type REAL*8 .
...
* ARR (input) : One-dimensional array of values (REAL*8)
