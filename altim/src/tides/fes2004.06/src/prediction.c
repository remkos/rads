 ...
 *  2.0 : Take in account the complete tidal spectral lines from Cartwright-Tayler-Edden
 */
#include "fes-int.h"
#define Q1	0
#define O1	1
...
// Tamura.
// Waves Mm, Mf and Mtm are removed.
//
...
*/
void lpeMinus4Waves(const double ts, const double lat, double* tlp)
{
    #define	N_WAVES_2ND	102
    ...
    static const float w2nd[N_WAVES_2ND][N_COEFS] =
    {
	{/* 0,*/  0,   0,   0,   1,   0,  0.02793},
	{/* 0,*/  0,   0,   0,   2,   0, -0.00027},
	{/* 0,*/  0,   0,   2,   1,   0,  0.00004},
    ...
    const static float w3rd[N_WAVES_3RD][N_COEFS] =
    {
	{/* 0,*/  0,   0,   1,   0,   0, -0.00021},
	{/* 0,*/  0,   2,  -1,   0,   0, -0.00004},
	{/* 0,*/  1,  -2,   0,   0,   0,  0.00004},
    ...
    for (ix = 0; ix < N_WAVES_3RD ; ix++)
    {
        tmp = w3rd[ix][0] * shpn[0] + w3rd[ix][1] * shpn[1] + 
	      w3rd[ix][2] * shpn[2] + w3rd[ix][3] * shpn[3] +   
	      w3rd[ix][4] * shpn[4];
    ...
    /* m -> cm */
    *tlp = ((1.0 - 0.609 /* H2 */ + 0.302 /* K2 */) * c20 * h20 + 
            (1.0 - 0.291 /* H3 */ + 0.093 /* K3 */) * c30 * h30) * 1e2;
