c
c read ASCII FLUX table and write to Binary format
c
      program flux2bin
      implicit none
...
c header record for binary file
      read(iunit,100,end=999) title,i4
      write(ounit) title,i4
