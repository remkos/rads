...
if (rads_version ('Add NCEP meteo models to RADS data', flag=flag)) return
...
if (new .and. nff(nf90_inq_varid(ncid,'dry_tropo_'//source,i)) .and. &
	nff(nf90_inq_varid(ncid,'wet_tropo_'//source,i))) then
	call log_records (0)
	return
endif
