...
call cpy_var ('ocean_tide_sol1+ocean_tide_equil+tide_non_equil', 'tide_ocean_got47')
call cpy_var ('load_tide_sol1', 'tide_load_got47')
call cpy_var ('ocean_tide_sol2+ocean_tide_equil+tide_non_equil', 'tide_ocean_fes04')
