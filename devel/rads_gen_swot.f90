...
!  swSW = SWOT satellite abbreviation
!     F = phase (a)
...
!
! This program handles SWOT OGDR, IGDR and GDR-F Level 2 products in NetCDF format.
! The format is described in:
!
! [1] SWOT Products Handbook, SALP-ST-M-EA-17043-CN (CNES)
!     Version 1.3, 11 Apr 2022
!-----------------------------------------------------------------------
!
...
if (rads_version ('Write SWOT GDR-F data to RADS', flag=flag)) return
call synopsis_devel (' < list_of_swot_file_names')
write (*,1310)
1310 format (/ &
'Additional [processing_options] are:' / &
'  --min-rec=MIN_REC         Specify minimum number of records per pass to process' // &
'This program converts SWOT OGDR/IGDR/GDR GDR-F Level 2 products to RADS data' / &
